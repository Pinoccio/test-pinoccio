...
- Switch pins - Driver D8 (high side load switch)
 ...
 - Test GPIO *
   - Iterate through Bitlash pins as outputs: RX0/TX0, D2-D8, A0-A7, SCK, MOSI, MISO, SS, RX1/TX1, SCL, SDA
   - Ensure set correctly
   
 - Test USB/16U2 USBSerial
    - Send test message to DUT UART0, test that expected response is returned
 ...
 - Backpack Bus
    - Read data from backpack bus
    - Write EEPROM on backpack bus
    - Read EEPROM on backpack bus
    
 - Update Wi-Fi module
    - Play back hex string sent on a previously recorded update
    - List APs available
 ...
 *
 * http://playground.arduino.cc/Code/Programmer2
 *
